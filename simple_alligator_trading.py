#!/usr/bin/env python3
"""
Simple working implementation of Alligator strategy with MT5
"""
...
class AlligatorStrategy:
    """
    Simple Alligator strategy implementation
    """
    ...
    def generate_signal(self, df):
        """
        Generate trading signal based on Alligator indicator
        """
        ...
        if len(positions) > 0:
            ...
            if (position.type == mt5.POSITION_TYPE_BUY and signal == "SELL") or \
               (position.type == mt5.POSITION_TYPE_SELL and signal == "BUY"):
                logger.info(f"Closing position due to opposite signal")
...
def main():
    ...
    strategy = AlligatorStrategy(symbol="EURUSD", timeframe=mt5.TIMEFRAME_M1)
    ...
    try:
        ...
        while True:
            ...
            # Log account info every 10 minutes
