#!/usr/bin/env python3
"""
Test script to verify phi3 model works with trading prompts
"""
...
def test_phi3_trading_response():
    """Test if phi3 model returns correct trading decisions"""
...
RESPOND: BUY/SELL/HOLD/CLOSE"""
    ...
    try:
        print(f"Testing phi3 trading decision with model: {model}")
        print("="*50)
...
if __name__ == "__main__":
    print("=== PHI3 TRADING RESPONSE TEST ===")
    print()
    test_phi3_trading_response()